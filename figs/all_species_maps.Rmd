...
The objective of this Rmd is to develop the maps that include all of the species data for the publication. Other maps will include data for specific taxa, these are found in the `maps_for_each_taxa` folder.
...
figure_save_path <- "/home/shares/aquaculture/AOA_climate_change/figures/maps_for_all_species/"
...
mainland_plot <- ggplot() +
  ...
  theme(# change the legend position and direction
    ...
    plot.background = element_rect(fill = "white",
                                    color = "white"))+  
  ggtitle("      All Species Mean Performance Index Under Current Ocean Conditions") +
...
mainland_index_change_245_2051_2070_plot <- ggplot() +
  ...
  ggtitle("      Change in All Species Mean Performance Index from Current Conditions\n      to SSP2 2051-2071") +
  # add in labels for states
  geom_spatvector_text(data = mainland_states %>% 
                         filter(!name %in% c("Maryland", "Delaware", "New Jersey", "Rhode Island")),
                       aes(label = postal),
...
mainland_current_count <- ggplot() +
  ...
  scale_fill_whitebox_c(palette = pal,
                        direction = dir,
                        limits = all_species_current_count_limits,
                        breaks = all_species_current_count_breaks,
                        #background color fill
                        na.value = "grey80",
                        name = "Species \nCount") +
  #remove x y breaks
  ...
  theme(# change the legend position and direction
    ...
    plot.background = element_rect(fill = "white",
                                    color = "white")) +  
  ggtitle("      All Species Viable Species Count Under Current Ocean Conditions") +
  # add in labels for states
  geom_spatvector_text(data = mainland_states %>% 
                         filter(!name %in% c("Maryland", "Delaware", "New Jersey", "Rhode Island")),
                       aes(label = postal),
...
count_change_245_2051_2070 <- ifel(test = count_change_245_2051_2070 > all_species_change_count_limits[2],
                                   yes = all_species_change_count_limits[2],
                                   no = ifel(count_change_245_2051_2070 < all_species_change_count_limits[1],
                                             yes = all_species_change_count_limits[1],
...
mainland_count_change_245_2051_2070_plot <- ggplot() +
  ...
  scale_fill_whitebox_c(palette = pal,
                        direction = dir,
                        limits = all_species_change_count_limits,
                        breaks = all_species_change_count_breaks,
                        #background color fill
                        na.value = "grey80",
                        name = "Change \nCount") +
  #remove x y breaks
  ...
  theme(# change the legend position and direction
    ...
    panel.background = element_rect(fill = "white", 
                                    color = NA),
    panel.border = element_rect(colour = NA, fill=NA))+  
  ggtitle("      Change in All Species Viable Species Count Under Current Ocean Conditions\n      to SSP2 2051-2071") +
  # add in labels for states
  geom_spatvector_text(data = mainland_states %>% 
                         filter(!name %in% c("Maryland", "Delaware", "New Jersey", "Rhode Island")),
                       aes(label = postal),
...
count_change_245_2071_2090 <- ifel(test = count_change_245_2071_2090 > all_species_change_count_limits[2],
                                   yes = all_species_change_count_limits[2],
                                   no = ifel(count_change_245_2071_2090 < all_species_change_count_limits[1],
                                             yes = all_species_change_count_limits[1],
...
count_change_585_2051_2070 <- ifel(test = count_change_585_2051_2070 > all_species_change_count_limits[2],
                                   yes = all_species_change_count_limits[2],
                                   no = ifel(count_change_585_2051_2070 < all_species_change_count_limits[1],
                                             yes = all_species_change_count_limits[1],
...
count_change_585_2071_2090 <- ifel(test = count_change_585_2071_2090 > all_species_change_count_limits[2],
                                   yes = all_species_change_count_limits[2],
                                   no = ifel(count_change_585_2071_2090 < all_species_change_count_limits[1],
                                             yes = all_species_change_count_limits[1],
