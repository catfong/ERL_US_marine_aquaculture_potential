...
figure_save_path <- "/home/shares/aquaculture/AOA_climate_change/figures/maps_for_each_taxa/finfish/"
...
current_index <- terra::mask(x = current_index,
                             mask = depth_mask)
current_index <- current_index$fish_mean_index
...
current_count <- terra::mask(x = current_count,
                             mask = depth_mask)
current_count <- current_count$fish_count
...
index_245_2051_2070 <- terra::mask(x = index_245_2051_2070,
                                   mask = depth_mask)
index_245_2051_2070 <- index_245_2051_2070$fish_mean_index
...
count_245_2051_2070 <- terra::mask(x = count_245_2051_2070,
                                   mask = depth_mask)
count_245_2051_2070 <- count_245_2051_2070$fish_count
...
index_245_2071_2090 <- terra::mask(x = index_245_2071_2090,
                                   mask = depth_mask)
index_245_2071_2090 <- index_245_2071_2090$fish_mean_index
...
count_245_2071_2090 <- terra::mask(x = count_245_2071_2090,
                                   mask = depth_mask)
count_245_2071_2090 <- count_245_2071_2090$fish_count
...
index_585_2051_2070 <- terra::mask(x = index_585_2051_2070,
                                   mask = depth_mask)
index_585_2051_2070 <- index_585_2051_2070$fish_mean_index
...
count_585_2051_2070 <- terra::mask(x = count_585_2051_2070,
                                   mask = depth_mask)
count_585_2051_2070 <- count_585_2051_2070$fish_count
...
index_585_2071_2090 <- terra::mask(x = index_585_2071_2090,
                                   mask = depth_mask)
index_585_2071_2090 <- index_585_2071_2090$fish_mean_index
...
count_585_2071_2090 <- terra::mask(x = count_585_2071_2090,
                                   mask = depth_mask)
count_585_2071_2090 <- count_585_2071_2090$fish_count
...
mainland_plot <- ggplot() +
  ...
  theme(# change the legend position and direction
    ...
    plot.background = element_rect(fill = "white",
                                    color = "white"))+  
  ggtitle("      Finfish Mean Performance Index Under Current Ocean Conditions") +
...
mainland_index_change_245_2051_2070_plot <- ggplot() +
  ...
  ggtitle("      Change in Finfish Mean Performance Index from Current Conditions\n      to SSP2 2051-2071") +
  # add in labels for states
  geom_spatvector_text(data = mainland_states %>% 
                         filter(!name %in% c("Maryland", "Delaware", "New Jersey", "Rhode Island")),
                       aes(label = postal),
...
mainland_current_count <- ggplot() +
  ...
  theme(# change the legend position and direction
    ...
    plot.background = element_rect(fill = "white",
                                    color = "white")) +  
  ggtitle("      Finfish Viable Species Count Under Current Ocean Conditions") +
  # add in labels for states
  geom_spatvector_text(data = mainland_states %>% 
                         filter(!name %in% c("Maryland", "Delaware", "New Jersey", "Rhode Island")),
                       aes(label = postal),
...
mainland_count_change_245_2051_2070_plot <- ggplot() +
  ...
  theme(# change the legend position and direction
    ...
    panel.background = element_rect(fill = "white", 
                                    color = NA),
    panel.border = element_rect(colour = NA, fill=NA))+  
  ggtitle("      Change in Finfish Viable Species Count Under Current Ocean Conditions\n      to SSP2 2051-2071") +
  # add in labels for states
  geom_spatvector_text(data = mainland_states %>% 
                         filter(!name %in% c("Maryland", "Delaware", "New Jersey", "Rhode Island")),
                       aes(label = postal),
