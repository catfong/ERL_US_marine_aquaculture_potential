...
figure_save_path <- "/home/shares/aquaculture/AOA_climate_change/figures/sensitivity_analysis/maps_for_each_taxa/seaweeds/"
...
base_current_count <- terra::mask(x = base_current_count,
                             mask = depth_mask)
base_current_count <- base_current_count$seaweed_count
...
current_count_75 <- terra::mask(x = current_count_75,
                             mask = depth_mask)
current_count_75 <- current_count_75$seaweed_count
...
base_count_245_2051_2070 <- terra::mask(x = base_count_245_2051_2070,
                                   mask = depth_mask)
base_count_245_2051_2070 <- base_count_245_2051_2070$seaweed_count
...
count_75_245_2051_2070 <- terra::mask(x = count_75_245_2051_2070,
                                   mask = depth_mask)
count_75_245_2051_2070 <- count_75_245_2051_2070$seaweed_count
...
base_count_245_2071_2090 <- terra::mask(x = base_count_245_2071_2090,
                                   mask = depth_mask)
base_count_245_2071_2090 <- base_count_245_2071_2090$seaweed_count
...
count_75_245_2071_2090 <- terra::mask(x = count_75_245_2071_2090,
                                   mask = depth_mask)
count_75_245_2071_2090 <- count_75_245_2071_2090$seaweed_count
...
base_count_585_2051_2070 <- terra::mask(x = base_count_585_2051_2070,
                                   mask = depth_mask)
base_count_585_2051_2070 <- base_count_585_2051_2070$seaweed_count
...
count_75_585_2051_2070 <- terra::mask(x = count_75_585_2051_2070,
                                   mask = depth_mask)
count_75_585_2051_2070 <- count_75_585_2051_2070$seaweed_count
...
base_count_585_2071_2090 <- terra::mask(x = base_count_585_2071_2090,
                                   mask = depth_mask)
base_count_585_2071_2090 <- base_count_585_2071_2090$seaweed_count
...
count_75_585_2071_2090 <- terra::mask(x = count_75_585_2071_2090,
                                   mask = depth_mask)
count_75_585_2071_2090 <- count_75_585_2071_2090$seaweed_count
...
mainland_count_change_current_plot <- ggplot() +
  ...
  ggtitle("      Change in Seaweeds Viable Species Count with Performance\n      Index Threshold at .75") +
...
mainland_count_change_245_2051_2070_plot <- ggplot() +
  ...
  theme(# change the legend position and direction
    ...
    panel.background = element_rect(fill = "white", 
                                    color = NA),
    panel.border = element_rect(colour = NA, fill=NA))+  
  ggtitle("      Change in Seaweeds Viable Species Count Count with Performance\n      Index Threshold at .75 under SSP2 2051-2071") +
  # add in labels for states
  geom_spatvector_text(data = mainland_states %>% 
                         filter(!name %in% c("Maryland", "Delaware", "New Jersey", "Rhode Island")),
                       aes(label = postal),
